...
export default function JobSearch() {
	...
	return (
		<div className='jobSearch'>
			...
			<div className="list">
				{
				page[nbrPage].length !== 0 ?
					page[nbrPage].map((annonce, key) => <Annonce annonce={annonce} key={key} setFenetreConsulterOuvert={setFenetreConsulterOuvert} setSelectedAnnonce={setSelectedAnnonce} />)
					:
